...
if (!function_exists('add_shortcode')) return "No direct call for Number Generator by Calculator.iO";

function display_ci_number_generator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/number-generator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Number Generator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_number_generator_iframe"></iframe></div>';
}

add_shortcode( 'ci_number_generator', 'display_ci_number_generator' );